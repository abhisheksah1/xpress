// ITU-T E.164 calling codes — Nepal first, then alphabetical by country name
const RAW = [
  ['Nepal', '+977'],
  ['Afghanistan', '+93'],
  ['Albania', '+355'],
...
export const COUNTRY_CODES = RAW.map(([country, code]) => ({
  country,
  code,
  label: `${country} (${code})`,
}));
...
export const phoneMaxLength = (countryCode) => (countryCode === '+977' ? 10 : 15);
