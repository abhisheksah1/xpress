...
export const createPage = asyncHandler(async (req, res) => {
  const page = await cmsService.createPage(mergeSeoPayload(req.validated.body), req.user._id);
...
export const updatePage = asyncHandler(async (req, res) => {
  const page = await cmsService.updatePage(req.params.id, mergeSeoPayload(req.validated.body), req.user._id);
